import TVShow from '../js/class/TVShow';
...
shows.add('Superhero', new TVShow( 'Batman',                     '1992',         'batman',             'The Dark Knight battles crime in Gotham City with occasional help from Robin and Batgirl.'));
